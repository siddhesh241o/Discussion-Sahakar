...
const Complaints = () => {
  ...
  return (
    <div className="mx-auto p-6 bg-gray-100 min-h-screen">
      {/* Header section */}
      <div className="flex gap-20 justify-between items-center bg-white p-4 rounded-lg shadow-md mb-5">
        <h1 className="font-medium text-2xl">Grievances List</h1>
        <button className="border rounded-md p-2 bg-blue-700 text-white px-6 hover:bg-blue-600">Apply Filter</button>
          ...
          <tbody>
            {complaints.map((complaint) => (
              <tr key={complaint.id} className="border-b">
                ...
                <td className="px-4 py-2">{complaint.dueDate}</td>
                <td className="px-4 py-2">{complaint.status}</td>
                <td className="px-4 py-2">{complaint.platform}</td>
                <td className="px-4 py-2">{complaint.location}</td>
                <td className="text-lime-800 cursor-pointer px-4 py-2">Change status</td>
                <td className="text-cyan-900 cursor-pointer px-4 py-2">Forward</td>
      ...
      {editingComplaint && (
        <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center">
          <div className="bg-white p-6 rounded-lg shadow-lg w-1/2" style={{ maxHeight: '80vh', overflowY: 'auto' }}>
