  ...
  return (
    <>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 p-6">
        {/* GIS Card */}
        <div
          className="relative w-full h-56 cursor-pointer rounded-2xl shadow-[0_1px_2px_rgba(0,0,0,0.3)] transform transition duration-300 hover:scale-105 overflow-hidden"
        ...
        >
          ...
          ></div>
          <div className="absolute bottom-0 w-full h-1/6 bg-gray-800 bg-opacity-90 flex items-center justify-center text-white font-bold text-lg">
            GIS
          </div>
        </div>
